...
module.exports = {
  ...
  plugins: [
    new webpack.DllPlugin({
      ...
      context: dirVars.RootDir, // 指定一个路径作为上下文环境，需要与DllReferencePlugin的context参数保持一致，建议统一设置为项目根目录
    }),
    /* 跟业务代码一样，该兼容的还是得兼容 */
  ...
  module: require('./webpack-config/module.pro.config.js'), // 沿用业务代码的module配置
